  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="flex flex-col h-full bg-white border border-gray-300 animate-in fade-in duration-300 antialiased text-sm">
        ...
        {/* BUSCA */}
        <div className="p-3 md:p-4 border-b border-gray-300 shrink-0 bg-white">
        ...
        <div className="flex-1 overflow-y-auto bg-white">
          {loading ? (
            <div className="flex justify-center items-center h-full text-gray-400 text-[13px] min-h-[200px]">
            ...
            <div className="divide-y divide-gray-200">
              {clientesFiltrados.map(item => {
                ...
                return (
                  <div key={item.id} className="flex flex-col md:flex-row md:items-center gap-3 md:gap-6 px-4 py-3 hover:bg-gray-50/60 transition-colors">
                    <div className="min-w-[220px]">
                      <p className="font-semibold text-[13px] text-gray-800 truncate">{item.nome_razao_social}</p>
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <span className="text-[11px] text-gray-500">{item.plataforma_inversor || 'Plataforma não informada'}</span>
                        {link && (
                    ...
                    <div className="flex flex-wrap items-center gap-x-8 gap-y-2 flex-1">
                      <div className="min-w-[160px]">
                        <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Login</span>
                        <CopyButton text={item.login_app} />
                      </div>
                      <div className="min-w-[160px]">
                        <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Senha</span>
